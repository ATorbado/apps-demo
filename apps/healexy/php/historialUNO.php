          ...
          <div class="container-fluid">
            <?php
              ...
              if (!isset($_REQUEST['cargarGrafica'])) {
                ...
                <form action='historialUNO.php' method='post'>
                  ...
                  <div class='form-group row text-uppercase text-danger text-center'>
                    <div class='col-xs-12 col-sm-4 mb-2 col-lg-4'>
                      <h2 class='font-weight-bold'>Elija fecha</h2>
                    </div>
                    <div class='col-xs-12 col-sm-4 mb-2 col-lg-4'>
                ...
                $fecha = $_REQUEST['fechahistorial1'];
                $aid = $_SESSION['user'];
                $aidi=obtenerID($aid);
                $Totalalimentos = TotalAaAlimentos($fecha, $aid);
                $alimentos = AaAlimentos($fecha, $aid);

                echo "
                <form action='historialUNO.php' method='post'>
                  <div class='form-group row'>
                    <div class='d-none d-md-block mb-2 col-md-3'></div>
                    <div class='col-sm-6 mb-2 col-lg-6 text-center'>
                      <h1>HISTORIAL DEL DÍA</h1></br>
                    </div>
                    <div class='d-none d-md-block mb-2 col-md-3'></div>
                  </div>
                ...
                if (comprobarFechadelUser($fecha, $aidi) == true) {

                  echo "
                    <legend class='text-center'>Datos del $fecha</legend>
                      <table class='table table-dark text-center'>
                        <thead class='thead-light'>
                          <tr>";
                              if (isset($alimentos)){
                                foreach ($alimentos[0] as $productos => $valor){
                                  echo "
                    ...
                    echo "
                        ...
                        <tbody>";
                            foreach ($alimentos as $productos){
                              echo "<tr>";
                        ...
                        $Totalales = $Totalalimentos[0];
                        $CantidadAlimentos = count($alimentos);
                        echo "<tr><td colspan='6' class='bg-secondary'> Valores Totales </td></tr>";

                    echo "
                          <tr>";
                          foreach ($Totalales as $datos){
                            echo "<td>$datos</td>";
                          }
                            echo "<td>$CantidadAlimentos</td>";
                    echo "
                          </tr>
                        <thead class='thead-light'>
                          <tr>";
                          foreach ($Totalales as $titulo => $value){
                            echo "<th>$titulo</th>";
                          }
                            echo "<th>TAlimentos</th>";
                    echo "
                          </tr>
                        </thead>
                        </tbody>
                ...
                echo "
                  ...
                  echo"<h2>No hay registro de datos almacenados ese día</h2>";
                }
              }
          ?>
    ...
    var myPieChart = new Chart(ctxP, {
      ...
      data: {
        ...
        datasets: [{
          data: [
            <?php
            echo" $Totalales[TCarbohidratos], $Totalales[TGrasas], $Totalales[TProteinas]";
            ?>
          ],
          backgroundColor: [
            'lime',
