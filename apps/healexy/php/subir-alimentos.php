...
<html lang='es'>
        ...
        <li class="nav-item">
          ...
          <div id="collapseDieta" class="collapse" aria-labelledby="collapseDieta" data-parent="#accordionSidebar">
            <div class="bg py-2 collapse-inner rounded deploy">
              ...
              <a class="collapse-item text-white" href="check/subir-alimentos.php">Guardar día</a>
            </div>
          </div>
        </li>
          ...
          <?php
            ...
            if (!isset($_REQUEST['upp'])) {
              echo "
                ...
                echo"
                <form action='subir-alimentos.php' method='post'>
                  <div class='form-group row text-center'>


                    <div class='d-none d-md-block mb-4 col-lg-1'></div>
                    <div class='col-xs-12 col-sm-4 mb-2 col-lg-2'>";
                      $TGramos="0";
                      for ($i=0; $i < count($alimentos); $i++) {
                        $TGramos  = $TGramos  + $alimentos[$i]['datos']['gramos'];
                      }
                      echo"
                      <div class='text-center'>
                        <h4 class='font-weight-bold text-hard-black'>Gramos Totales:</h4>
                        <h3 class='text-orange'>$TGramos</h3>
                      </div>
                    </div>
                    ...
                    <div class='col-xs-12 col-sm-4 mb-2 col-lg-2'>";
                      $TCalorias="0";
                      for ($i=0; $i < count($alimentos); $i++) {
                        $TCalorias  = $TCalorias  + $alimentos[$i]['datos']['calorias'];
                      }
                      echo"
                      <div class='text-center'>
                        <h4 class='font-weight-bold text-hard-black'>Calorias Totales:</h4>
                        <h3 class='text-orange'>$TCalorias</h3>
                      </div>
                    </div>
                    ...
                    <div class='col-xs-12 col-sm-4 mb-2 col-lg-2'>";
                      $TCarbohidratos ="0";
                      for ($i=0; $i < count($alimentos); $i++) {
                        $TCarbohidratos  = $TCarbohidratos  + $alimentos[$i]['datos']['carbohidratos'];
                      }
                      echo"
                      <div class='text-center'>
                        <h4 class='font-weight-bold text-hard-black'>Carbohidratos Totales:</h4>
                        <h3 class='text-orange'>$TCarbohidratos</h3>
                      </div>
                    </div>
                    ...
                    <div class='col-xs-12 col-sm-4 mb-2 col-lg-2'>";
                      $TGrasas ="0";
                      for ($i=0; $i < count($alimentos); $i++) {
                        $TGrasas  = $TGrasas  + $alimentos[$i]['datos']['grasas'];
                      }
                      echo"
                      <div class='text-center'>
                        <h4 class='font-weight-bold text-hard-black'>Grasas Totales:</h4>
                        <h3 class='text-orange'>$TGrasas</h3>
                      </div>
                    </div>
                    ...
                    <div class='col-xs-12 col-sm-4 mb-2 col-lg-2'>";
                      $TProteinas ="0";
                      for ($i=0; $i < count($alimentos); $i++) {
                        $TProteinas  = $TProteinas  + $alimentos[$i]['datos']['proteinas'];
                      }
                      echo"
                      <div class='text-center'>
                        <h4 class='font-weight-bold text-hard-black'>Proteinas Totales:</h4>
                        <h3 class='text-orange'>$TProteinas</h3>
                      </div>
                    </div>
                  ...
                  <div class='form-group row'>
                    <div class='col-xs-12 col-sm-4 mb-2 col-lg-6'>
                      <input type='submit' name='upp' value='Guardar alimentos' class='btn btn-primary btn-block'>
                    </div>
                    <div class='col-xs-12 col-sm-4 mb-2 col-lg-6'>
                ...
                $_SESSION['datos']=array(
                  'TGramos' => $TGramos,
                  'TCalorias' => $TCalorias,
                  'TCarbohidratos' => $TCarbohidratos,
                  'TGrasas' => $TGrasas,
                  'TProteinas' => $TProteinas
                );
              ...
              if (comprobarFechaOnly($aidi) == true) {
                $info = $_SESSION['datos'];
                $datainfo = $_SESSION['comida'];
                $upDates1 = subirDatosBD($aidi, $info);
                $upDates2 = subirDatosBDAliMentos($aidi, $datainfo);
                if ($upDates1 == true) {
                  echo"<h2>Se han almacenado los datos correctamente</h2>";
                  //echo "<a href='inicio.php'><h4>Volver al inicio</h4></a>";
                  header("refresh:1;url=inicio.php");
                }
              }else{
                echo"<h2>Ya has alamacenado hoy los alimentos</h2>";
                header("refresh:1;url=inicio.php");
                //echo "<a href='subir-alimentos.php'><h4>Ver alimentos</h4></a>";
              }
            }
          ?>
  ...
  <script type="text/javascript">
    ...
    var myPieChart = new Chart(ctxP, {
      type: 'pie',
      data: {
        labels: ["Carbohidratos", "Grasas", "Proteinas"],
        datasets: [{
          data: [
            <?php
            echo" $TCarbohidratos, $TGrasas, $TProteinas";
            ?>
          ],
          backgroundColor: [
            'lime',
