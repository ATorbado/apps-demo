          ...
          <div class="container-fluid">
            <div class='col-sm-12 mb-2 col-lg-12'>
              ...
              <?php
                ...
                $alim=Mostrar_Alimento();
                echo "$alim";

                //Muestra la tabla de comida del dia
                $comi=Mostrar_Comidadeldia();
                echo "$comi";

                //Muestra la tabla del peso
                $dia=Mostrar_Diaadia();
                echo "$dia";
                ...
                //Muestra la tabla de los alimentos consumidos del día
                $alidia=Mostrar_alimentosdeldia();
                echo "$alidia";
